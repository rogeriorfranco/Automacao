<%@ Page Async="true" Language="C#" AutoEventWireup="true" CodeBehind="ViewPortabilidade.aspx.cs" Inherits="AutomacaoWeb.page.ViewPortabilidade" %>
...
<head runat="server">
    ...
    <script src="../scripts/portabilidade.js"></script>
</head>
<body>
    ...
    <form id="form1" runat="server">
        ...
        <section class="content-header">
            <h1>Portabilidade<small><asp:Label ID="lblSubTituloCaso" runat="server"></asp:Label></small>
                ...
                <div class="box-body">
                    ...
                    <div class='row'>
                        ...
                        <ol>
                            ...
                            <li class="text-light-blue">Código do parceiro que realizou a portabilidade</li>
                            ...
                            <li class="text-light-blue">Login do operador que realizou a portabilidade</li>
                            ...
                            <li class="text-light-blue">Há contrato assinado solicitando a portabilidade?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                            ...
                            <li class="text-light-blue">Há gravação relacionada a portabilidade?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                            ...
                            <div class="pai">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" InitialValue="" ControlToValidate="rbQuestao_8" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <li class="text-light-blue">Há token de aceite eletrônico ou transcrição do chat solicitando a portabilidade?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" InitialValue="" ControlToValidate="rbQuestao_9" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <li class="text-light-blue">Existe protocolo de sistema ou assinado de solicitação de portabilidade?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" InitialValue="" ControlToValidate="rbQuestao_10" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <div class="pai">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" InitialValue="" ControlToValidate="rbQuestao_11" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <div class="pai">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" InitialValue="" ControlToValidate="rbQuestao_12" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <div class="pai">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" InitialValue="" ControlToValidate="rbQuestao_13" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <li class="text-light-blue">Há histórico de portabilidade da ABR Telecom?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" InitialValue="" ControlToValidate="rbQuestao_14" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <li class="text-light-blue">A solicitação foi atendida dentro do prazo?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                            ...
                            <li class="text-light-blue">Portabilidade concluída em sistema?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                            ...
                            <li class="text-light-blue">Houve erro na operadora de origem?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                            ...
                            <li class="text-light-blue">Há conflito de dados entre as operadoras doadora e receptora?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                            ...
                            <li class="text-light-blue">Caso a Claro seja doadora, a reclamação do cliente é não receber ligações da Claro?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                            ...
                            <li class="text-light-blue">Houve desistência?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator22" runat="server" InitialValue="" ControlToValidate="rbQuestao_20" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <li class="text-light-blue">Existe multa contratual?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                            ...
                            <div class="pai">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator28" runat="server" InitialValue="" ControlToValidate="rbQuestao_27" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <div class="pai">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator29" runat="server" InitialValue="" ControlToValidate="rbQuestao_28" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <div class="pai">
                                <div class="minhas-colunas">
                                    <asp:RadioButtonList ID="rbQuestao_29" runat="server" class="radio" RepeatLayout="Flow" RepeatDirection="Horizontal">
                                        <asp:ListItem class="radio-inline" Value="Sim">Sim</asp:ListItem>
                                        <asp:ListItem class="radio-inline" Value="Nao">Não</asp:ListItem>
                                        <asp:ListItem class="radio-inline" Value="N/A">Não se Aplica</asp:ListItem>
                                    </asp:RadioButtonList>
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator30" runat="server" InitialValue="" ControlToValidate="rbQuestao_29" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <asp:TextBox ID="printQuestao_29" CssClass="printImage" BorderStyle="Dashed" runat="server" TextMode="MultiLine" Height="50px" Width="100%" ClientIDMode="Static" placeholder="Printar Aqui ..."></asp:TextBox>
                            <asp:TextBox ID="txtObsQuestao_29" runat="server" TextMode="MultiLine" Height="50px" Width="100%" placeholder="Observações"></asp:TextBox>
                            ...
                            <asp:TextBox ID="printQuestao_31" CssClass="printImage" BorderStyle="Dashed" runat="server" TextMode="MultiLine" Height="50px" Width="100%" ClientIDMode="Static" placeholder="Printar Aqui ..."></asp:TextBox>
                            <asp:TextBox ID="txtObsQuestao_31" runat="server" TextMode="MultiLine" Height="50px" Width="100%" placeholder="Observações"></asp:TextBox>
