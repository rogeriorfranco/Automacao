<%@ Page Async="true" Language="C#" AutoEventWireup="true" CodeBehind="ViewCancelamento.aspx.cs" Inherits="AutomacaoWeb.page.ViewCancelamento" %>
...
<head runat="server">
    ...
    <script src="../scripts/cancelamento.js"></script>

</head>
<body>
    <form id="formCancel" runat="server">

        <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>


        <section class="content-header">
            <h1>Cancelamento<small><asp:Label ID="lblSubTituloCaso" runat="server"></asp:Label></small>
                        ...
                        <ol>
                            ...
                            <div class="pai">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator28" runat="server" InitialValue="" ControlToValidate="rbQuestao_1" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <ol>
                                ...
                                <div class="pai">
                                    ...
                                    <div class="minhas-colunas" style="margin-top: 5px;">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" InitialValue="" ControlToValidate="rbQuestao_1_2_0" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                ...
                                <div class="pai">
                                    ...
                                    <div class="minhas-colunas" style="margin-top: 5px;">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" InitialValue="" ControlToValidate="rbQuestao_1_3_0" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            ...
                            <div class="pai">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" InitialValue="" ControlToValidate="rbQuestao_4" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <div class="pai">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" InitialValue="" ControlToValidate="rbQuestao_5" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <div class="pai">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" InitialValue="" ControlToValidate="rbQuestao_6" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <li class="text-light-blue">Possui fatura(s) paga(s) e não contestadas após a solicitação?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" InitialValue="" ControlToValidate="rbQuestao_8" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <li class="text-light-blue">Há OS da retirada do equipamento da residência?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                                    <asp:RadioButtonList ID="rbQuestao_9" runat="server" class="radio" RepeatLayout="Flow" RepeatDirection="Horizontal" Width="250px">
                                        <asp:ListItem class="radio-inline" Value="Sim">Sim</asp:ListItem>
                                        <asp:ListItem class="radio-inline" Value="Nao">Não</asp:ListItem>
                                        <asp:ListItem class="radio-inline" Value="N/A">Não se Aplica</asp:ListItem>
                                    </asp:RadioButtonList>
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" InitialValue="" ControlToValidate="rbQuestao_9" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                                <div id="divGerarDadosOS" style="display: none" runat="server">
                                    <asp:TextBox ID="txtOsQuestao_9" runat="server" Width="300px" ClientIDMode="Static" placeholder="Separar as OS por ';' Ex: 1010;1010"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="pai">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" InitialValue="" ControlToValidate="rbQuestao_10" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <div class="pai">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" InitialValue="" ControlToValidate="rbQuestao_11" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <div class="pai">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" InitialValue="" ControlToValidate="rbQuestao_12" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <li class="text-light-blue">Código do parceiro que realizou o cancelamento</li>
                            <asp:TextBox ID="txtQuestao_13" runat="server" placeholder="Código.."></asp:TextBox>
                            ...
                            <li class="text-light-blue">Login do operador que realizou o cancelamento</li>
                            <asp:TextBox ID="txtQuestao_14" runat="server" placeholder="Login..."></asp:TextBox>
                            ...
                            <li class="text-light-blue">Há gravação relacionada ao cancelamento?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" InitialValue="" ControlToValidate="rbQuestao_15" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <li class="text-light-blue">Há token de aceite eletrônico ou transcrição do chat solicitando o cancelamento?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" InitialValue="" ControlToValidate="rbQuestao_16" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <li class="text-light-blue">Existe protocolo de sistema ou assinado de solicitação de cancelamento?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" InitialValue="" ControlToValidate="rbQuestao_17" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <li class="text-light-blue">O cancelamento foi realizado a pedido do autor?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator19" runat="server" InitialValue="" ControlToValidate="rbQuestao_18" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <li class="text-light-blue">Cliente foi retido ou revertido?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator20" runat="server" InitialValue="" ControlToValidate="rbQuestao_19" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <li class="text-light-blue">Existe reclamação/solicitações após o pedido de cancelamento que não sejam sobre o cancelamento?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator21" runat="server" InitialValue="" ControlToValidate="rbQuestao_20" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <li class="text-light-blue">Possui utilização/tráfego após o pedido de cancelamento?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator22" runat="server" InitialValue="" ControlToValidate="rbQuestao_21" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <div class="pai">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator23" runat="server" InitialValue="" ControlToValidate="rbQuestao_22" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <li class="text-light-blue">Foram geradas faturas após a solicitação?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator24" runat="server" InitialValue="" ControlToValidate="rbQuestao_23" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <asp:TextBox ID="printQuestao_23" BorderStyle="Dashed" CssClass="printImage" runat="server" TextMode="MultiLine" Height="50px" Width="100%" ClientIDMode="Static" placeholder="Printar Aqui ..."></asp:TextBox>
                            ...
                            <li class="text-light-blue">Existe pró-rata?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator25" runat="server" InitialValue="" ControlToValidate="rbQuestao_24" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <li class="text-light-blue">Há parcelamento de aparelho?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator26" runat="server" InitialValue="" ControlToValidate="rbQuestao_25" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <li class="text-light-blue">Há OS de desconexão de serviço?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator27" runat="server" InitialValue="" ControlToValidate="rbQuestao_26" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <asp:TextBox ID="txtQuestao_27" runat="server" TextMode="MultiLine" Height="100px" Width="100%"></asp:TextBox>
                            <br />
                            <br />
