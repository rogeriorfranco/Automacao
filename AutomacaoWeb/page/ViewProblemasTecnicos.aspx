<%@ Page Async="true" Language="C#" AutoEventWireup="true" CodeBehind="ViewProblemasTecnicos.aspx.cs" Inherits="AutomacaoWeb.page.ViewProblemasTecnicos" %>
...
<head runat="server">
    ...
    <script src="../scripts/problemastecnicos.js"></script>
</head>
<body>
    ...
    <form id="form1" runat="server">
        ...
        <section class="content-header">
            <h1>Problemas Técnicos<small><asp:Label ID="lblSubTituloCaso" runat="server"></asp:Label></small>
                ...
                <div class="box-body">
                    ...
                    <div class='row'>
                        ...
                        <ol>
                            ...
                            <asp:TextBox ID="printQuestao_1" CssClass="printImage" Border tyle="Dashed" runat="server" TextMode="MultiLine" Height="50px" Width="100%" ClientIDMode="Static" placeholder="Printar Aqui ..."></asp:TextBox>
                            ...
                            <li class="text-light-blue">Data da instalação</li>
                            ...
                            <li class="text-light-blue">Houve solicitação de visita técnica?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                            ...
                            <li class="text-light-blue">Há OS comprovando?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                            ...
                            <li class="text-light-blue">Houve cobrança da taxa de visita?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                            ...
                            <li class="text-light-blue">Visita realizada dentro do prazo?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                            ...
                            <li class="text-light-blue">Houve instalação dos serviços fora do padrão?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                            ...
                            <li class="text-light-blue">A instalação ocorreu no endereço contratado?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                            ...
                            <li class="text-light-blue">A instalação ocorreu no mesmo endereço informado na inicial?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" InitialValue="" ControlToValidate="rbQuestao_13" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <div class="pai">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" InitialValue="" ControlToValidate="rbQuestao_14" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <div class="pai">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" InitialValue="" ControlToValidate="rbQuestao_15" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <div class="pai">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator19" runat="server" InitialValue="" ControlToValidate="rbQuestao_16" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <div class="pai">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator20" runat="server" InitialValue="" ControlToValidate="rbQuestao_17" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
