...
{
    public partial class ViewProblemasComVendas : System.Web.UI.Page
    {
        private async Task populaCampos()
        {
            try
            {
                if (!string.IsNullOrEmpty(Request.QueryString["id_caso"]))
                {
                    ...
                    form = await formularioBll.readAsync(id_caso, (int)Util.TFormulario.ProblemasComVendas);
                    if (form != null)
                    {
                        ...
                        ProblemasComVendasBLL problemasVendasBll = new ProblemasComVendasBLL();
                        var f = await problemasVendasBll.read(form.id);
                        ...
                        UserControlExecQuestao1.tipoFormulario = Convert.ToInt16(Util.TFormulario.ProblemasComVendas);
                        UserControlQuestao5.tipoFormulario = Convert.ToInt16(Util.TFormulario.ProblemasComVendas);
        ...
        private void update(ProblemasComVenda f)
        {
            try
            {
                FormularioBll formularioBll = new FormularioBll();
        ...
        {
            ProblemasComVenda p = new ProblemasComVenda();
