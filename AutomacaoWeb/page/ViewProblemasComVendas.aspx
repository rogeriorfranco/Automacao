<%@ Page Async="true" Language="C#" AutoEventWireup="true" CodeBehind="ViewProblemasComVendas.aspx.cs" Inherits="AutomacaoWeb.page.ViewProblemasComVendas" %>
...
<head runat="server">
    ...
    <script src="../scripts/problemascomvendas.js"></script>
</head>
<body>
    ...
    <form id="form1" runat="server">
        ...
        <section class="content-header">
            <h1>Problemas com vendas<small><asp:Label ID="lblSubTituloCaso" runat="server"></asp:Label></small>
                ...
                <div class="box-body">
                    ...
                    <div class='row'>
                        ...
                        <ol>
                            ...
                            <asp:RequiredFieldValidator ID="rfvtxtQuestao_4" runat="server" InitialValue="" ControlToValidate="txtQuestao_4" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                            ...
                            <asp:RequiredFieldValidator ID="rfvtxtQuestao_5" runat="server" InitialValue="" ControlToValidate="txtQuestao_5" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                            ...
                            <li class="text-light-blue">Há contrato assinado com detalhes da venda?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                            ...
                            <li class="text-light-blue">Há gravação relacionada ao problema com a venda?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                            ...
                            <li class="text-light-blue">Há token de aceite eletrônico ou transcrição do chat informando o valor reclamado ao cliente?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                            ...
                            <li class="text-light-blue">Existe protocolo de reclamação/solicitações quanto ao valor cobrado?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                            ...
                            <li class="text-light-blue">Adquiriu produtos/aparelho?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                            ...
                            <li class="text-light-blue">Existe parcelamento de aparelho?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                            ...
                            <asp:TextBox ID="printQuestao_20" BorderStyle="Dashed" CssClass="printImage" runat="server" TextMode="MultiLine" Height="50px" Width="100%" ClientIDMode="Static" placeholder="Printar Aqui ..."></asp:TextBox>
                            ...
                            <li class="text-light-blue">Houveram ações internas para resolver o problema?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                            ...
                            <li class="text-light-blue">Houve alteração de tarifa?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                            ...
                            <li class="text-light-blue">Plano contratado é o mesmo ofertado?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                                    <asp:RadioButtonList ID="rbQuestao_24" runat="server" class="radio" RepeatLayout="Flow" RepeatDirection="Horizontal" ClientIDMode="Static">
                                        <asp:ListItem class="radio-inline" Value="Sim">Sim</asp:ListItem>
                                        <asp:ListItem class="radio-inline" Value="Nao">Não</asp:ListItem>
                                        <asp:ListItem class="radio-inline" Value="N/A">Não se Aplica</asp:ListItem>
                                    </asp:RadioButtonList>
                            ...
                            <div id="divGerarDadosOS" style="display: none" runat="server">
                                <asp:TextBox ID="txtOsQuestao_24" runat="server" Width="40%" ClientIDMode="Static" placeholder="Separar as OS por ';' Ex: 1010;1010"></asp:TextBox>
                            </div>
