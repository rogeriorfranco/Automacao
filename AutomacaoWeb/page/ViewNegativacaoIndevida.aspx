<%@ Page Async="true" Language="C#" AutoEventWireup="true" CodeBehind="ViewNegativacaoIndevida.aspx.cs" Inherits="AutomacaoWeb.page.ViewNegativacaoIndevida" %>
...
<head runat="server">
    ...
    <script src="../scripts/negativacaoindevida.js"></script>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <section class="content-header">
            <h1>Cobrança/Negativação Indevida<small><asp:Label ID="lblSubTituloCaso" runat="server"></asp:Label></small>
                ...
                <div class="box-body">
                    ...
                    <div class='row'>
                        ...
                        <ol>
                            ...
                            <li class="text-light-blue">Data da instalação - Data habilitação do produto </li>
                            ...
                            <li class="text-light-blue">Há gravação com detalhes do produto ou serviço reclamado?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                            ...
                            <li class="text-light-blue">Há token de aceite eletrônico ou transcrição do chat com detalhes do produto ou serviço reclamado?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                            ...
                            <li class="text-light-blue">Existe contrato assinado com detalhes do produto ou serviço reclamado?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                            ...
                            <li class="text-light-blue">Existe protocolo de reclamação/solicitações quanto ao valor reclamado?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                            ...
                            <li class="text-light-blue">Possui utilização/tráfego de chamadas similares em outras faturas pagas e não contestadas?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
