<%@ Page Language="C#" Async="true" AutoEventWireup="true" CodeBehind="ViewRedeCobertura.aspx.cs" Inherits="AutomacaoWeb.page.ViewRedeCobertura" %>
...
<head runat="server">
    ...
    <script src="../scripts/rede-cobertura.js"></script>
...
<body>
    <form id="formRedeCobertura" runat="server">
        ...
        <section class="content-header">
            <h1>Rede Cobertura<small><asp:Label ID="lblSubTituloCaso" runat="server"></asp:Label></small>
                        ...
                        <ol>
                            ...
                            <div class="pai">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="rfv1" runat="server" InitialValue="" ControlToValidate="rbQuestao_1" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <asp:RequiredFieldValidator ID="rftxtDtInsQuestao_2" runat="server" InitialValue="" ControlToValidate="txtDtInsQuestao_2" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                            ...
                            <li class="text-light-blue">Existe protocolo de reclamação/solicitações quanto ao serviço/produto reclamado?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="rfv3" runat="server" InitialValue="" ControlToValidate="rbQuestao_3" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <div class="pai">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="rfv4" runat="server" InitialValue="" ControlToValidate="rbQuestao_4" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <li class="text-light-blue">Cliente reclama de negativação realizada pelo grupo? Anexar tela que comprove ou não a negativação.</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="rfv5" runat="server" InitialValue="" ControlToValidate="rbQuestao_5" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <div class="pai">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="rfv6" runat="server" InitialValue="" ControlToValidate="rbQuestao_6" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <li class="text-light-blue">Anormalidade temporária?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="rfv7" runat="server" InitialValue="" ControlToValidate="rbQuestao_7" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <li class="text-light-blue">Foi necessário ajuste na rede?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="rfv8" runat="server" InitialValue="" ControlToValidate="rbQuestao_8" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <li class="text-light-blue">Houve comunicação aos consumidores sobre o problema na rede?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="rfv9" runat="server" InitialValue="" ControlToValidate="rbQuestao_9" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <li class="text-light-blue">Há utilização durante o período reclamado?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="rfv10" runat="server" InitialValue="" ControlToValidate="rbQuestao_10" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <li class="text-light-blue">Endereço informado possui cobertura?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="rfv11" runat="server" InitialValue="" ControlToValidate="rbQuestao_11" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <li class="text-light-blue">Há faturas pagas e não contestadas durante o período reclamado?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="rfv12" runat="server" InitialValue="" ControlToValidate="rbQuestao_12" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <li class="text-light-blue">Há extrato de ligações pré pagas?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="rfv13" runat="server" InitialValue="" ControlToValidate="rbQuestao_13" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <div class="pai">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="rfv14" runat="server" InitialValue="" ControlToValidate="rbQuestao_14" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <div class="pai">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="rfv15" runat="server" InitialValue="" ControlToValidate="rbQuestao_15" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <div class="pai">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="rfv16" runat="server" InitialValue="" ControlToValidate="rbQuestao_16" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <div class="pai">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" InitialValue="" ControlToValidate="rbQuestao_16" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
