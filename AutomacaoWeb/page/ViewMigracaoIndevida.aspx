<%@ Page Async="true" Language="C#" AutoEventWireup="true" CodeBehind="ViewMigracaoIndevida.aspx.cs" Inherits="AutomacaoWeb.page.ViewMigracaoIndevida" %>
...
<head runat="server">
    ...
    <script src="../scripts/migracaoindevida.js"></script>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <section class="content-header">
            <h1>Migração Indevida<small><asp:Label ID="lblSubTituloCaso" runat="server"></asp:Label></small>
                ...
                <div class="box-body">
                    ...
                    <div class='row'>
                        ...
                        <ol>
                            ...
                            <li class="text-light-blue">Data da migração</li>
                            <asp:TextBox ID="txtDtMigracaoQuestao_4" runat="server" placeholder="Data..." ClientIDMode="Static" MaxLength="10"></asp:TextBox>
                            ...
                            <li class="text-light-blue">Cliente desconhece a migração?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                            ...
                            <li class="text-light-blue">Há gravação com solicitação da migração?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                            ...
                            <li class="text-light-blue">Gravação é favorável à companhia?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" InitialValue="" ControlToValidate="rbQuestao_7" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <li class="text-light-blue">Há token de aceite eletrônico ou transcrição do chat com detalhes da migração?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" InitialValue="" ControlToValidate="rbQuestao_8" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <li class="text-light-blue">Existe contrato assinado com detalhes da migração?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" InitialValue="" ControlToValidate="rbQuestao_9" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <li class="text-light-blue">Existe protocolo de reclamação/solicitações quanto a migração?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" InitialValue="" ControlToValidate="rbQuestao_10" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <li class="text-light-blue">Consta pacote/plano/modalidade de origem e destino?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" InitialValue="" ControlToValidate="rbQuestao_11" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <li class="text-light-blue">Por quanto tempo a linha ficou como pré-paga?</li>
                            <div class="pai">
                                <div class="minhas-colunas">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" InitialValue="" ControlToValidate="rbQuestao_12" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <div class="pai">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" InitialValue="" ControlToValidate="rbQuestao_13" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <div class="pai">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" InitialValue="" ControlToValidate="rbQuestao_14" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <div class="pai">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" InitialValue="" ControlToValidate="rbQuestao_15" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <div class="pai">
                                ...
                                <div class="minhas-colunas" style="margin-top: 5px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" InitialValue="" ControlToValidate="rbQuestao_16" ErrorMessage="Campo Obrigatório !" CssClass="alert alert-danger" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
