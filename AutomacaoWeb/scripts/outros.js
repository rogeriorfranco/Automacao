...
$(document).ready(function () {
    if ($('#hfFormularioId').val() != "") {
        ...
        loadImages('tbl_printQuestao_7__1', $('#hfFormularioId').val(), 7, 1);
        loadImages('tbl_printQuestao_7__2', $('#hfFormularioId').val(), 7, 2);
        loadImages('tbl_printQuestao_7__3', $('#hfFormularioId').val(), 7, 3);
        ...
        loadImages('tbl_printQuestao_30', $('#hfFormularioId').val(), 30, 0);
    }
  });
...
function atribuiMascara() {
    ...
    $('#txtDtInsQuestao_2').datepicker({ format: 'dd/mm/yyyy', language: 'pt-BR', autoclose: true });
    $('#txtDtInsQuestao_2').inputmask('99/99/9999');

    $('#txtDtHabQuestao_2').datepicker({ format: 'dd/mm/yyyy', language: 'pt-BR', autoclose: true });
    $('#txtDtHabQuestao_2').inputmask('99/99/9999');
...
function mascaraTelefone() {
    ...
    var tel = document.querySelector('input[name="UserControlExecQuestao1$txtTelefone"]');
    if (tel != null) {
