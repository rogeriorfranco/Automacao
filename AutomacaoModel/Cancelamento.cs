...
namespace AutomacaoModel
{
    ...
    public class Cancelamento
    {
        ...
        public DateTime? questao_3 { get; set; }
        public string obs_questao_3 { get; set; }
        [MaxLength(15)] public string questao_4 { get; set; }
        public string obs_questao_4 { get; set; }
        [MaxLength(15)] public string questao_5 { get; set; }
        public string obs_questao_5 { get; set; }
        [MaxLength(15)] public string questao_6 { get; set; }
        public string obs_questao_6 { get; set; }
        [MaxLength(15)] public string questao_7 { get; set; }
        public string obs_questao_7 { get; set; }
        [MaxLength(15)] public string questao_8 { get; set; }
        public string obs_questao_8 { get; set; }
        [MaxLength(15)] public string questao_9 { get; set; }
        public string obs_questao_9 { get; set; }
        public string os_questao_9 { get; set; }
        [MaxLength(15)] public string questao_10 { get; set; }
        public string obs_questao_10 { get; set; }
        [MaxLength(15)] public string questao_11 { get; set; }
        public string obs_questao_11 { get; set; }
        [MaxLength(15)] public string questao_12 { get; set; }
        public string obs_questao_12 { get; set; }        
        [MaxLength(400)] public string questao_13 { get; set; }
        public string obs_questao_13 { get; set; }
        [MaxLength(400)] public string questao_14 { get; set; }
